        ...
        do{
            ...
            for (int i = 1; i < tabuleiro.length-1; i++) {
                for (int j = 1; j < tabuleiro[i].length-1; j++) {
                    //CASO 3 ESFERAS
                    if((tabuleiro[i-1][j] == tabuleiro[i][j]) && (tabuleiro[i][j] == tabuleiro[i+1][j]) ||
                        (tabuleiro[i][j-1] == tabuleiro[i][j]) && (tabuleiro[i][j] == tabuleiro[i][j+1])){
            ...
            if(contador == 0 & quantidadeDeEsferas > 3){
            turnoExtra = true;
            }
            contador++;
    ...
    public void quebraEsferas(){
        ...
        for (int i = 2; i < tabuleiro.length-2; i++) {
            for (int j = 2; j < tabuleiro[i].length-2; j++) {
                ...
                //VERTICAL
                if((tabuleiro[i-2][j]== tabuleiro[i-1][j]) && (tabuleiro[i-1][j] == tabuleiro[i][j]) && (tabuleiro[i][j] == tabuleiro[i+1][j]) && (tabuleiro[i+1][j] == tabuleiro[i+2][j])){
        ...
        for (int i = 2; i < tabuleiro.length-1; i++) {
            for (int j = 2; j < tabuleiro[i].length-1; j++) {
                //HORIZONTAL
                ...
                //VERTICAL 
                if((tabuleiro[i-2][j] == tabuleiro[i-1][j]) && (tabuleiro[i-1][j] == tabuleiro[i][j]) && (tabuleiro[i][j] == tabuleiro[i+1][j])){
        ...
        for (int i = 1; i < tabuleiro.length-2; i++) {
            for (int j = 1; j < tabuleiro[i].length-2; j++) {
                //HORIZONTAL
                if((tabuleiro[i][j-1] == tabuleiro[i][j]) && (tabuleiro[i][j] == tabuleiro[i][j+1]) && (tabuleiro[i][j+1] == tabuleiro[i][j+2])){
                ...
                //VERTICAL
                if((tabuleiro[i-1][j] == tabuleiro[i][j]) && (tabuleiro[i][j] == tabuleiro[i+1][j]) && (tabuleiro[i+1][j] == tabuleiro[i+2][j])){
